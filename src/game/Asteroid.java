...
public class Asteroid implements Movable{
	...
	public Asteroid() {
		...
		movement = BackgroundImage.getMovement() - 2;
	...
	private void getAsteroidImages() {
		asteroidImages.add( new ImageIcon(Spaceship.class.getResource("/game/Resources/asteroid7.png")).getImage());
		asteroidImages.add( new ImageIcon(Spaceship.class.getResource("/game/Resources/asteroid8.png")).getImage());
		asteroidImages.add( new ImageIcon(Spaceship.class.getResource("/game/Resources/asteroid9.png")).getImage());	
	}
